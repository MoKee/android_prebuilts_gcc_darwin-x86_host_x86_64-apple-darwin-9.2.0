...
enum opt_code
{
  ...
  OPT_Tbss_ = 144,                           /* -Tbss= */
  OPT_Tdata = 145,                           /* -Tdata */
  OPT_Tdata_ = 146,                          /* -Tdata= */
  OPT_Ttext = 147,                           /* -Ttext */
  OPT_Ttext_ = 148,                          /* -Ttext= */
  OPT_U = 149,                               /* -U */
  /* OPT_W = 150, */                         /* -W */
  OPT_Wa_ = 151,                             /* -Wa, */
  OPT_Wabi = 152,                            /* -Wabi */
  OPT_Wabi_tag = 153,                        /* -Wabi-tag */
  OPT_Wabi_ = 154,                           /* -Wabi= */
  OPT_Wabsolute_value = 155,                 /* -Wabsolute-value */
  OPT_Waddress = 156,                        /* -Waddress */
  OPT_Waddress_of_packed_member = 157,       /* -Waddress-of-packed-member */
  OPT_Waggregate_return = 158,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 159,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 160,                       /* -Waliasing */
  OPT_Walign_commons = 161,                  /* -Walign-commons */
  /* OPT_Waligned_new = 162, */              /* -Waligned-new */
  OPT_Waligned_new_ = 163,                   /* -Waligned-new= */
  OPT_Wall = 164,                            /* -Wall */
  OPT_Walloc_size_larger_than_ = 165,        /* -Walloc-size-larger-than= */
  OPT_Walloc_zero = 166,                     /* -Walloc-zero */
  OPT_Walloca = 167,                         /* -Walloca */
  OPT_Walloca_larger_than_ = 168,            /* -Walloca-larger-than= */
  OPT_Wampersand = 169,                      /* -Wampersand */
  OPT_Wargument_mismatch = 170,              /* -Wargument-mismatch */
  ...
  /* OPT_Wattribute_alias = 175, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 176,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 177,              /* -Wattribute-warning */
  OPT_Wattributes = 178,                     /* -Wattributes */
  OPT_Wbad_function_cast = 179,              /* -Wbad-function-cast */
  OPT_Wbool_compare = 180,                   /* -Wbool-compare */
  OPT_Wbool_operation = 181,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 182,   /* -Wbuiltin-declaration-mismatch */
  ...
  OPT_Wc__17_compat = 188,                   /* -Wc++17-compat */
  /* OPT_Wc__1z_compat = 189, */             /* -Wc++1z-compat */
  OPT_Wc_binding_type = 190,                 /* -Wc-binding-type */
  OPT_Wc11_c2x_compat = 191,                 /* -Wc11-c2x-compat */
  OPT_Wc90_c99_compat = 192,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 193,                 /* -Wc99-c11-compat */
  OPT_Wcannot_profile = 194,                 /* -Wcannot-profile */
  OPT_Wcast_align = 195,                     /* -Wcast-align */
  OPT_Wcast_align_strict = 196,              /* -Wcast-align=strict */
  OPT_Wcast_function_type = 197,             /* -Wcast-function-type */
  OPT_Wcast_qual = 198,                      /* -Wcast-qual */
  OPT_Wcast_result = 199,                    /* -Wcast-result */
  /* OPT_Wcatch_value = 200, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 201,                   /* -Wcatch-value= */
  OPT_Wchar_subscripts = 202,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 203,           /* -Wcharacter-truncation */
  OPT_Wchkp = 204,                           /* -Wchkp */
  OPT_Wclass_conversion = 205,               /* -Wclass-conversion */
  OPT_Wclass_memaccess = 206,                /* -Wclass-memaccess */
  OPT_Wclobbered = 207,                      /* -Wclobbered */
  OPT_Wcomment = 208,                        /* -Wcomment */
  /* OPT_Wcomments = 209, */                 /* -Wcomments */
  OPT_Wcompare_reals = 210,                  /* -Wcompare-reals */
  OPT_Wconditionally_supported = 211,        /* -Wconditionally-supported */
  OPT_Wconversion = 212,                     /* -Wconversion */
  OPT_Wconversion_extra = 213,               /* -Wconversion-extra */
  OPT_Wconversion_null = 214,                /* -Wconversion-null */
  OPT_Wcoverage_mismatch = 215,              /* -Wcoverage-mismatch */
  OPT_Wcpp = 216,                            /* -Wcpp */
  OPT_Wctor_dtor_privacy = 217,              /* -Wctor-dtor-privacy */
  OPT_Wdangling_else = 218,                  /* -Wdangling-else */
  OPT_Wdate_time = 219,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 220,    /* -Wdeclaration-after-statement */
  OPT_Wdelete_incomplete = 221,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 222,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdeprecated = 223,                     /* -Wdeprecated */
  OPT_Wdeprecated_copy = 224,                /* -Wdeprecated-copy */
  OPT_Wdeprecated_copy_dtor = 225,           /* -Wdeprecated-copy-dtor */
  OPT_Wdeprecated_declarations = 226,        /* -Wdeprecated-declarations */
  OPT_Wdesignated_init = 227,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 228,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 229,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 230,           /* -Wdiscarded-qualifiers */
  OPT_Wdiv_by_zero = 231,                    /* -Wdiv-by-zero */
  OPT_Wdo_subscript = 232,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 233,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 234,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 235,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 236,                /* -Wduplicated-cond */
  OPT_Weffc__ = 237,                         /* -Weffc++ */
  OPT_Wempty_body = 238,                     /* -Wempty-body */
  OPT_Wendif_labels = 239,                   /* -Wendif-labels */
  OPT_Wenum_compare = 240,                   /* -Wenum-compare */
  OPT_Werror = 241,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 242, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 243,                         /* -Werror= */
  OPT_Wexpansion_to_defined = 244,           /* -Wexpansion-to-defined */
  OPT_Wextra = 245,                          /* -Wextra */
  OPT_Wextra_semi = 246,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 247,                   /* -Wfatal-errors */
  OPT_Wfloat_conversion = 248,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 249,                    /* -Wfloat-equal */
  /* OPT_Wformat = 250, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 251,            /* -Wformat-contains-nul */
  ...
  OPT_Wnonportable_cfstrings = 335,          /* -Wnonportable-cfstrings */
  /* OPT_Wnormalized = 336, */               /* -Wnormalized */
  OPT_Wnormalized_ = 337,                    /* -Wnormalized= */
  OPT_Wnull_dereference = 338,               /* -Wnull-dereference */
  OPT_Wodr = 339,                            /* -Wodr */
  OPT_Wold_style_cast = 340,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 341,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 342,           /* -Wold-style-definition */
  OPT_Wopenmp_simd = 343,                    /* -Wopenmp-simd */
  OPT_Woverflow = 344,                       /* -Woverflow */
  OPT_Woverlength_strings = 345,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 346,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 347,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 348,     /* -Woverride-init-side-effects */
  OPT_Wp_ = 349,                             /* -Wp, */
  OPT_Wpacked = 350,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 351,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 352,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 353,                         /* -Wpadded */
  OPT_Wparentheses = 354,                    /* -Wparentheses */
  OPT_Wpedantic = 355,                       /* -Wpedantic */
  OPT_Wpessimizing_move = 356,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 357, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 358,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 359,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 360,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 361,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 362,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 363,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 364,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 365,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 366,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 367,                       /* -Wprotocol */
  OPT_Wpsabi = 368,                          /* -Wpsabi */
  OPT_Wreal_q_constant = 369,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 370,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 371,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 372,                /* -Wredundant-decls */
  OPT_Wredundant_move = 373,                 /* -Wredundant-move */
  OPT_Wregister = 374,                       /* -Wregister */
  OPT_Wreorder = 375,                        /* -Wreorder */
  OPT_Wrestrict = 376,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 377,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 378,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 379,           /* -Wscalar-storage-order */
  OPT_Wselector = 380,                       /* -Wselector */
  OPT_Wsequence_point = 381,                 /* -Wsequence-point */
  OPT_Wshadow = 382,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 383, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 384,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 385, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 386,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 387, */            /* -Wshadow=global */
  OPT_Wshadow_local = 388,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 389,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 390,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 391,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 392, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 393,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 394,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 395,                /* -Wsign-conversion */
  OPT_Wsign_promo = 396,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 397,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 398,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_pointer_div = 399,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 400,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 401,                    /* -Wspeculative */
  OPT_Wstack_protector = 402,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 403,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 404,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 405,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 406,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 407,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 408,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 409,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 410,          /* -Wstrict-selector-match */
  /* OPT_Wstringop_overflow = 411, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 412,             /* -Wstringop-overflow= */
  OPT_Wstringop_truncation = 413,            /* -Wstringop-truncation */
  OPT_Wsubobject_linkage = 414,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 415,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 416,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 417,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 418,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 419,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 420,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 421,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 422,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 423,               /* -Wsuggest-override */
  OPT_Wsurprising = 424,                     /* -Wsurprising */
  OPT_Wswitch = 425,                         /* -Wswitch */
  OPT_Wswitch_bool = 426,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 427,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 428,                    /* -Wswitch-enum */
  OPT_Wswitch_unreachable = 429,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 430,                      /* -Wsync-nand */
  OPT_Wsynth = 431,                          /* -Wsynth */
  OPT_Wsystem_headers = 432,                 /* -Wsystem-headers */
  OPT_Wtabs = 433,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 434,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 435,           /* -Wtautological-compare */
  OPT_Wtemplates = 436,                      /* -Wtemplates */
  OPT_Wterminate = 437,                      /* -Wterminate */
  OPT_Wtraditional = 438,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 439,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 440,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 441,                      /* -Wtrigraphs */
  OPT_Wtype_limits = 442,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 443,            /* -Wundeclared-selector */
  OPT_Wundef = 444,                          /* -Wundef */
  OPT_Wundefined_do_loop = 445,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 446,                      /* -Wunderflow */
  OPT_Wuninitialized = 447,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 448,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 449, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 450, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 451,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 452,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 453,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 454,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 455, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 456,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 457,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 458,                /* -Wunused-function */
  OPT_Wunused_label = 459,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 460,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 461,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 462,               /* -Wunused-parameter */
  OPT_Wunused_result = 463,                  /* -Wunused-result */
  OPT_Wunused_value = 464,                   /* -Wunused-value */
  OPT_Wunused_variable = 465,                /* -Wunused-variable */
  OPT_Wuse_without_only = 466,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 467,                   /* -Wuseless-cast */
  OPT_Wvarargs = 468,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 469,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 470,   /* -Wvector-operation-performance */
  OPT_Wvirtual_inheritance = 471,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 472,            /* -Wvirtual-move-assign */
  OPT_Wvla = 473,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 474,               /* -Wvla-larger-than= */
  OPT_Wvolatile_register_var = 475,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 476,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 477,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzerotrip = 478,                       /* -Wzerotrip */
  OPT_X = 479,                               /* -X */
  OPT_Xassembler = 480,                      /* -Xassembler */
  OPT_Xf = 481,                              /* -Xf */
  OPT_Xlinker = 482,                         /* -Xlinker */
  OPT_Xpreprocessor = 483,                   /* -Xpreprocessor */
  OPT_Z = 484,                               /* -Z */
  OPT_Zall_load = 485,                       /* -Zall_load */
  OPT_Zallowable_client = 486,               /* -Zallowable_client */
  OPT_Zarch_errors_fatal = 487,              /* -Zarch_errors_fatal */
  OPT_Zbind_at_load = 488,                   /* -Zbind_at_load */
  OPT_Zbundle = 489,                         /* -Zbundle */
  OPT_Zbundle_loader = 490,                  /* -Zbundle_loader */
  OPT_Zdead_strip = 491,                     /* -Zdead_strip */
  OPT_Zdylib_file = 492,                     /* -Zdylib_file */
  OPT_Zdynamic = 493,                        /* -Zdynamic */
  OPT_Zdynamiclib = 494,                     /* -Zdynamiclib */
  OPT_Zexported_symbols_list = 495,          /* -Zexported_symbols_list */
  OPT_Zflat_namespace = 496,                 /* -Zflat_namespace */
  OPT_Zfn_seg_addr_table_filename = 497,     /* -Zfn_seg_addr_table_filename */
  OPT_Zforce_cpusubtype_ALL = 498,           /* -Zforce_cpusubtype_ALL */
  OPT_Zforce_flat_namespace = 499,           /* -Zforce_flat_namespace */
  OPT_Zimage_base = 500,                     /* -Zimage_base */
  OPT_Zinit = 501,                           /* -Zinit */
  OPT_Zinstall_name = 502,                   /* -Zinstall_name */
  OPT_Zmulti_module = 503,                   /* -Zmulti_module */
  OPT_Zmultiply_defined = 504,               /* -Zmultiply_defined */
  OPT_Zmultiplydefinedunused = 505,          /* -Zmultiplydefinedunused */
  OPT_Zno_dead_strip_inits_and_terms = 506,  /* -Zno_dead_strip_inits_and_terms */
  OPT_Zseg_addr_table = 507,                 /* -Zseg_addr_table */
  OPT_Zsegaddr = 508,                        /* -Zsegaddr */
  OPT_Zsegs_read_only_addr = 509,            /* -Zsegs_read_only_addr */
  OPT_Zsegs_read_write_addr = 510,           /* -Zsegs_read_write_addr */
  OPT_Zsingle_module = 511,                  /* -Zsingle_module */
  OPT_Zumbrella = 512,                       /* -Zumbrella */
  OPT_Zunexported_symbols_list = 513,        /* -Zunexported_symbols_list */
  OPT_Zweak_reference_mismatches = 514,      /* -Zweak_reference_mismatches */
  /* OPT_all_load = 515, */                  /* -all_load */
  /* OPT_allowable_client = 516, */          /* -allowable_client */
  OPT_ansi = 517,                            /* -ansi */
  OPT_arch = 518,                            /* -arch */
  /* OPT_arch_errors_fatal = 519, */         /* -arch_errors_fatal */
  OPT_asm_macosx_version_min_ = 520,         /* -asm_macosx_version_min= */
  OPT_aux_info = 521,                        /* -aux-info */
  /* OPT_aux_info_ = 522, */                 /* -aux-info= */
  OPT_auxbase = 523,                         /* -auxbase */
  OPT_auxbase_strip = 524,                   /* -auxbase-strip */
  /* OPT_bind_at_load = 525, */              /* -bind_at_load */
  /* OPT_bundle = 526, */                    /* -bundle */
  /* OPT_bundle_loader = 527, */             /* -bundle_loader */
  OPT_c = 528,                               /* -c */
  OPT_client_name = 529,                     /* -client_name */
  OPT_compatibility_version = 530,           /* -compatibility_version */
  OPT_coverage = 531,                        /* -coverage */
  OPT_cpp = 532,                             /* -cpp */
  OPT_cpp_ = 533,                            /* -cpp= */
  OPT_current_version = 534,                 /* -current_version */
  OPT_d = 535,                               /* -d */
  /* OPT_dead_strip = 536, */                /* -dead_strip */
  OPT_debuglib_ = 537,                       /* -debuglib= */
  OPT_defaultlib_ = 538,                     /* -defaultlib= */
  /* OPT_dependency_file = 539, */           /* -dependency-file */
  OPT_dstartfiles = 540,                     /* -dstartfiles */
  OPT_dumpbase = 541,                        /* -dumpbase */
  OPT_dumpdir = 542,                         /* -dumpdir */
  OPT_dumpfullversion = 543,                 /* -dumpfullversion */
  OPT_dumpmachine = 544,                     /* -dumpmachine */
  OPT_dumpspecs = 545,                       /* -dumpspecs */
  OPT_dumpversion = 546,                     /* -dumpversion */
  /* OPT_dylib_file = 547, */                /* -dylib_file */
  OPT_dylinker = 548,                        /* -dylinker */
  OPT_dylinker_install_name = 549,           /* -dylinker_install_name */
  /* OPT_dynamic = 550, */                   /* -dynamic */
  /* OPT_dynamiclib = 551, */                /* -dynamiclib */
  OPT_e = 552,                               /* -e */
  OPT_export_dynamic = 553,                  /* -export-dynamic */
  /* OPT_exported_symbols_list = 554, */     /* -exported_symbols_list */
  OPT_fPIC = 555,                            /* -fPIC */
  OPT_fPIE = 556,                            /* -fPIE */
  OPT_fRTS_ = 557,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 558,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 559,                   /* -fabi-version= */
  OPT_faccess_control = 560,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 561,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 562,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 563,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 564,                  /* -falign-commons */
  OPT_falign_functions = 565,                /* -falign-functions */
  OPT_falign_functions_ = 566,               /* -falign-functions= */
  OPT_falign_jumps = 567,                    /* -falign-jumps */
  OPT_falign_jumps_ = 568,                   /* -falign-jumps= */
  OPT_falign_labels = 569,                   /* -falign-labels */
  OPT_falign_labels_ = 570,                  /* -falign-labels= */
  OPT_falign_loops = 571,                    /* -falign-loops */
  OPT_falign_loops_ = 572,                   /* -falign-loops= */
  /* OPT_faligned_new = 573, */              /* -faligned-new */
  OPT_faligned_new_ = 574,                   /* -faligned-new= */
  OPT_fall_instantiations = 575,             /* -fall-instantiations */
  OPT_fall_intrinsics = 576,                 /* -fall-intrinsics */
  OPT_fall_virtual = 577,                    /* -fall-virtual */
  OPT_fallow_leading_underscore = 578,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 579,/* -fallow-parameterless-variadic-functions */
  OPT_falt_external_templates = 580,         /* -falt-external-templates */
  OPT_fapple_kext = 581,                     /* -fapple-kext */
  /* OPT_fargument_alias = 582, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 583, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 584, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 585, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 586,            /* -fasan-shadow-offset= */
  OPT_fasm = 587,                            /* -fasm */
  OPT_fassert = 588,                         /* -fassert */
  OPT_fassociative_math = 589,               /* -fassociative-math */
  OPT_fassume_phsa = 590,                    /* -fassume-phsa */
  OPT_fasynchronous_unwind_tables = 591,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 592,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 593,                   /* -fauto-profile */
  OPT_fauto_profile_ = 594,                  /* -fauto-profile= */
  OPT_fautomatic = 595,                      /* -fautomatic */
  OPT_fbackslash = 596,                      /* -fbackslash */
  OPT_fbacktrace = 597,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 598,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 599,                   /* -fbounds-check */
  OPT_fbounds_check_ = 600,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 601,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 602,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 603,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 604,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 605,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 606,                /* -fbuilding-libgcc */
  OPT_fbuilding_libphobos_tests = 607,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 608,                        /* -fbuiltin */
  OPT_fbuiltin_ = 609,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 610,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 611,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 612,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 613,                    /* -fcall-saved- */
  OPT_fcall_used_ = 614,                     /* -fcall-used- */
  OPT_fcaller_saves = 615,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 616,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 617, */            /* -fcf-protection */
  OPT_fcf_protection_ = 618,                 /* -fcf-protection= */
  OPT_fchar8_t = 619,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 620,        /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 621, */          /* -fcheck-data-deps */
  OPT_fcheck_new = 622,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 623,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 624,                         /* -fcheck= */
  OPT_fchecking = 625,                       /* -fchecking */
  OPT_fchecking_ = 626,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 627,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 628,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 629,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 630,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 631,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 632,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 633,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 634,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 635, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 636,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 637,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 638,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 639, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 640,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 641,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 642,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 643,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 644,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 645, */                 /* -fcilkplus */
  OPT_fcoarray_ = 646,                       /* -fcoarray= */
  OPT_fcode_hoisting = 647,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 648,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 649,                         /* -fcommon */
  OPT_fcompare_debug = 650,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 651,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 652,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 653,                   /* -fcompare-elim */
  OPT_fconcepts = 654,                       /* -fconcepts */
  OPT_fcond_mismatch = 655,                  /* -fcond-mismatch */
  /* OPT_fconserve_space = 656, */           /* -fconserve-space */
  OPT_fconserve_stack = 657,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 658,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 659,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 660,          /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 661,           /* -fconstexpr-ops-limit= */
  OPT_fconvert_ = 662,                       /* -fconvert= */
  OPT_fcprop_registers = 663,                /* -fcprop-registers */
  OPT_fcray_pointer = 664,                   /* -fcray-pointer */
  OPT_fcrossjumping = 665,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 666,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 667, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 668,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 669,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 670,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 671,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 672,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 673,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 674,                       /* -fdbg-cnt= */
  OPT_fdce = 675,                            /* -fdce */
  OPT_fdebug = 676,                          /* -fdebug */
  OPT_fdebug_cpp = 677,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 678,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 679,            /* -fdebug-types-section */
  OPT_fdebug_ = 680,                         /* -fdebug= */
  OPT_fdec = 681,                            /* -fdec */
  OPT_fdec_include = 682,                    /* -fdec-include */
  OPT_fdec_intrinsic_ints = 683,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 684,                       /* -fdec-math */
  OPT_fdec_static = 685,                     /* -fdec-static */
  OPT_fdec_structure = 686,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 687,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 688,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 689,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 690, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 691,              /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 692,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 693,                /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 694,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 695,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 696,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 697,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 698,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 699,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 700,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 701,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 702, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 703,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_format_ = 704,            /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 705,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 706,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 707,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_show_caret = 708,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_labels = 709,        /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 710,  /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 711,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 712,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_template_tree = 713, /* -fdiagnostics-show-template-tree */
  OPT_fdirectives_only = 714,                /* -fdirectives-only */
  OPT_fdisable_ = 715,                       /* -fdisable- */
  OPT_fdoc = 716,                            /* -fdoc */
  OPT_fdoc_dir_ = 717,                       /* -fdoc-dir= */
  OPT_fdoc_file_ = 718,                      /* -fdoc-file= */
  OPT_fdoc_inc_ = 719,                       /* -fdoc-inc= */
  OPT_fdollar_ok = 720,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 721,         /* -fdollars-in-identifiers */
  OPT_fdruntime = 722,                       /* -fdruntime */
  OPT_fdse = 723,                            /* -fdse */
  OPT_fdump_ = 724,                          /* -fdump- */
  OPT_fdump_ada_spec = 725,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 726,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 727, */                /* -fdump-core */
  OPT_fdump_d_original = 728,                /* -fdump-d-original */
  OPT_fdump_final_insns = 729,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 730,              /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 731,            /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 732,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 733,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 734,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 735,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 736,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 737, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 738,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 739,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 740,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 741,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 742,                 /* -fearly-inlining */
  OPT_felide_constructors = 743,             /* -felide-constructors */
  OPT_felide_type = 744,                     /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 745, */    /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 746, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 747,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 748,        /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 749,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 750,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 751,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 752,                        /* -fenable- */
  OPT_fenforce_eh_specs = 753,               /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 754,                 /* -fenum-int-equiv */
  OPT_fexceptions = 755,                     /* -fexceptions */
  OPT_fexcess_precision_ = 756,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 757,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 758,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 759,           /* -fext-numeric-literals */
  OPT_fextended_identifiers = 760,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 761,                /* -fextern-tls-init */
  OPT_fexternal_blas = 762,                  /* -fexternal-blas */
  OPT_fexternal_templates = 763,             /* -fexternal-templates */
  OPT_ff2c = 764,                            /* -ff2c */
  OPT_ffast_math = 765,                      /* -ffast-math */
  OPT_ffat_lto_objects = 766,                /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 767,               /* -ffile-prefix-map= */
  OPT_ffinite_math_only = 768,               /* -ffinite-math-only */
  OPT_ffixed_ = 769,                         /* -ffixed- */
  OPT_ffixed_form = 770,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 771,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 772,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 773,                    /* -ffloat-store */
  OPT_ffor_scope = 774,                      /* -ffor-scope */
  /* OPT_fforce_addr = 775, */               /* -fforce-addr */
  OPT_fforward_propagate = 776,              /* -fforward-propagate */
  OPT_ffp_contract_ = 777,                   /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 778,         /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 779,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 780,                      /* -ffpe-trap= */
  OPT_ffree_form = 781,                      /* -ffree-form */
  OPT_ffree_line_length_ = 782,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 783,          /* -ffree-line-length-none */
  OPT_ffreestanding = 784,                   /* -ffreestanding */
  OPT_ffriend_injection = 785,               /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 786,      /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 787,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 788,                   /* -ffunction-cse */
  OPT_ffunction_sections = 789,              /* -ffunction-sections */
  OPT_fgcse = 790,                           /* -fgcse */
  OPT_fgcse_after_reload = 791,              /* -fgcse-after-reload */
  OPT_fgcse_las = 792,                       /* -fgcse-las */
  OPT_fgcse_lm = 793,                        /* -fgcse-lm */
  OPT_fgcse_sm = 794,                        /* -fgcse-sm */
  OPT_fgimple = 795,                         /* -fgimple */
  OPT_fgnat_encodings_ = 796,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 797,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 798,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 799,                         /* -fgnu-tm */
  OPT_fgnu_unique = 800,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 801,                   /* -fgnu89-inline */
  OPT_fgo_c_header_ = 802,                   /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 803,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 804,           /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 805,           /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 806,                /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 807,          /* -fgo-debug-escape-hash= */
  OPT_fgo_dump_ = 808,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 809,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 810,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 811,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 812,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 813,                       /* -fgraphite */
  OPT_fgraphite_identity = 814,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 815,       /* -fguess-branch-probability */
  OPT_fguiding_decls = 816,                  /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 817, */        /* -fhandle-exceptions */
  /* OPT_fhelp = 818, */                     /* -fhelp */
  /* OPT_fhelp_ = 819, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 820,           /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 821,                      /* -fhonor-std */
  OPT_fhosted = 822,                         /* -fhosted */
  OPT_fhuge_objects = 823,                   /* -fhuge-objects */
  OPT_fident = 824,                          /* -fident */
  OPT_fif_conversion = 825,                  /* -fif-conversion */
  OPT_fif_conversion2 = 826,                 /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 827,         /* -fignore-unknown-pragmas */
  OPT_filelist = 828,                        /* -filelist */
  OPT_fimplement_inlines = 829,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 830,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 831,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 832,             /* -fimplicit-templates */
  OPT_findirect_inlining = 833,              /* -findirect-inlining */
  OPT_findirect_virtual_calls = 834,         /* -findirect-virtual-calls */
  OPT_finhibit_size_directive = 835,         /* -finhibit-size-directive */
  OPT_finit_character_ = 836,                /* -finit-character= */
  OPT_finit_derived = 837,                   /* -finit-derived */
  OPT_finit_integer_ = 838,                  /* -finit-integer= */
  OPT_finit_local_zero = 839,                /* -finit-local-zero */
  OPT_finit_logical_ = 840,                  /* -finit-logical= */
  OPT_finit_real_ = 841,                     /* -finit-real= */
  OPT_finline = 842,                         /* -finline */
  OPT_finline_atomics = 843,                 /* -finline-atomics */
  OPT_finline_functions = 844,               /* -finline-functions */
  OPT_finline_functions_called_once = 845,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 846, */            /* -finline-limit- */
  OPT_finline_limit_ = 847,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 848,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 849,         /* -finline-small-functions */
  OPT_finput_charset_ = 850,                 /* -finput-charset= */
  OPT_finstrument_functions = 851,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 852,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 853,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 854,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 855,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 856,        /* -fintrinsic-modules-path= */
  OPT_finvariants = 857,                     /* -finvariants */
  OPT_fipa_bit_cp = 858,                     /* -fipa-bit-cp */
  OPT_fipa_cp = 859,                         /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 860, */         /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 861,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 862,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 863,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 864,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 865, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 866,                    /* -fipa-profile */
  OPT_fipa_pta = 867,                        /* -fipa-pta */
  OPT_fipa_pure_const = 868,                 /* -fipa-pure-const */
  OPT_fipa_ra = 869,                         /* -fipa-ra */
  OPT_fipa_reference = 870,                  /* -fipa-reference */
  OPT_fipa_reference_addressable = 871,      /* -fipa-reference-addressable */
  OPT_fipa_sra = 872,                        /* -fipa-sra */
  OPT_fipa_stack_alignment = 873,            /* -fipa-stack-alignment */
  /* OPT_fipa_struct_reorg = 874, */         /* -fipa-struct-reorg */
  OPT_fipa_vrp = 875,                        /* -fipa-vrp */
  OPT_fira_algorithm_ = 876,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 877,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 878,              /* -fira-loop-pressure */
  OPT_fira_region_ = 879,                    /* -fira-region= */
  OPT_fira_share_save_slots = 880,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 881,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 882,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 883,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 884,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 885,               /* -fivar-visibility= */
  OPT_fivopts = 886,                         /* -fivopts */
  OPT_fjump_tables = 887,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 888,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 889,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 890,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 891,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 892,          /* -fkeep-static-functions */
  OPT_flabels_ok = 893,                      /* -flabels-ok */
  /* OPT_flat_namespace = 894, */            /* -flat_namespace */
  OPT_flax_vector_conversions = 895,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 896,             /* -fleading-underscore */
  OPT_flifetime_dse = 897,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 898,                  /* -flifetime-dse= */
  OPT_flimit_function_alignment = 899,       /* -flimit-function-alignment */
  OPT_flinker_output_ = 900,                 /* -flinker-output= */
  /* OPT_flive_patching = 901, */            /* -flive-patching */
  OPT_flive_patching_ = 902,                 /* -flive-patching= */
  OPT_flive_range_shrinkage = 903,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 904,                    /* -flocal-ivars */
  /* OPT_floop_block = 905, */               /* -floop-block */
  /* OPT_floop_flatten = 906, */             /* -floop-flatten */
  OPT_floop_interchange = 907,               /* -floop-interchange */
  OPT_floop_nest_optimize = 908,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 909, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 910,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 911, */          /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 912,            /* -floop-unroll-and-jam */
  OPT_flra_remat = 913,                      /* -flra-remat */
  OPT_flto = 914,                            /* -flto */
  OPT_flto_compression_level_ = 915,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 916,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 917,                 /* -flto-partition= */
  OPT_flto_report = 918,                     /* -flto-report */
  OPT_flto_report_wpa = 919,                 /* -flto-report-wpa */
  OPT_flto_ = 920,                           /* -flto= */
  OPT_fltrans = 921,                         /* -fltrans */
  OPT_fltrans_output_list_ = 922,            /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 923,              /* -fmacro-prefix-map= */
  OPT_fmain = 924,                           /* -fmain */
  OPT_fmath_errno = 925,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 926,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 927,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 928,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 929,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 930,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 931,                     /* -fmem-report */
  OPT_fmem_report_wpa = 932,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 933,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 934,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 935,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 936,                /* -fmessage-length= */
  OPT_fmodule_file_ = 937,                   /* -fmodule-file= */
  OPT_fmodule_private = 938,                 /* -fmodule-private */
  OPT_fmoduleinfo = 939,                     /* -fmoduleinfo */
  OPT_fmodulo_sched = 940,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 941,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 942,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 943,                  /* -fms-extensions */
  OPT_fmudflap = 944,                        /* -fmudflap */
  OPT_fmudflapir = 945,                      /* -fmudflapir */
  OPT_fmudflapth = 946,                      /* -fmudflapth */
  OPT_fname_mangling_version_ = 947,         /* -fname-mangling-version- */
  OPT_fnew_abi = 948,                        /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 949,           /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 950,               /* -fnew-ttp-matching */
  OPT_fnext_runtime = 951,                   /* -fnext-runtime */
  OPT_fnil_receivers = 952,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 953,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 954,               /* -fnonansi-builtins */
  OPT_fnonnull_objects = 955,                /* -fnonnull-objects */
  OPT_fnothrow_opt = 956,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 957,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 958,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 959,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 960,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 961,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 962,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 963,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 964,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 965,                   /* -foffload-abi= */
  OPT_foffload_ = 966,                       /* -foffload= */
  OPT_fomit_frame_pointer = 967,             /* -fomit-frame-pointer */
  OPT_fonly_ = 968,                          /* -fonly= */
  OPT_fopenacc = 969,                        /* -fopenacc */
  OPT_fopenacc_dim_ = 970,                   /* -fopenacc-dim= */
  OPT_fopenmp = 971,                         /* -fopenmp */
  OPT_fopenmp_simd = 972,                    /* -fopenmp-simd */
  OPT_foperator_names = 973,                 /* -foperator-names */
  OPT_fopt_info = 974,                       /* -fopt-info */
  OPT_fopt_info_ = 975,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 976, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 977,         /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 978,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 979, */           /* -foptional-diags */
  /* OPT_force_cpusubtype_ALL = 980, */      /* -force_cpusubtype_ALL */
  /* OPT_force_flat_namespace = 981, */      /* -force_flat_namespace */
  OPT_fpack_derived = 982,                   /* -fpack-derived */
  OPT_fpack_struct = 983,                    /* -fpack-struct */
  OPT_fpack_struct_ = 984,                   /* -fpack-struct= */
  OPT_fpad_source = 985,                     /* -fpad-source */
  OPT_fpartial_inlining = 986,               /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 987,      /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 988,              /* -fpcc-struct-return */
  OPT_fpch_deps = 989,                       /* -fpch-deps */
  OPT_fpch_preprocess = 990,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 991,                     /* -fpeel-loops */
  OPT_fpeephole = 992,                       /* -fpeephole */
  OPT_fpeephole2 = 993,                      /* -fpeephole2 */
  OPT_fpermissive = 994,                     /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 995,    /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 996,                            /* -fpic */
  OPT_fpie = 997,                            /* -fpie */
  OPT_fplan9_extensions = 998,               /* -fplan9-extensions */
  OPT_fplt = 999,                            /* -fplt */
  OPT_fplugin_arg_ = 1000,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1001,                       /* -fplugin= */
  OPT_fpost_ipa_mem_report = 1002,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1003,                /* -fpostconditions */
  OPT_fpre_include_ = 1004,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1005,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1006,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1007,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1008,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1009,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1010,              /* -fpretty-templates */
  OPT_fprintf_return_value = 1011,           /* -fprintf-return-value */
  OPT_fprofile = 1012,                       /* -fprofile */
  OPT_fprofile_abs_path = 1013,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1014,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1015,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1016,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1017,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1018,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1019,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1020,             /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 1021,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1022,                /* -fprofile-report */
  OPT_fprofile_update_ = 1023,               /* -fprofile-update= */
  OPT_fprofile_use = 1024,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1025,                  /* -fprofile-use= */
  OPT_fprofile_values = 1026,                /* -fprofile-values */
  OPT_fprotect_parens = 1027,                /* -fprotect-parens */
  OPT_framework = 1028,                      /* -framework */
  OPT_frandom_seed = 1029,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1030,                  /* -frandom-seed= */
  OPT_frange_check = 1031,                   /* -frange-check */
  OPT_freal_4_real_10 = 1032,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1033,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1034,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1035,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1036,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1037,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1038,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1039,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1040,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1041,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1042,               /* -frecord-marker=8 */
  OPT_frecursive = 1043,                     /* -frecursive */
  OPT_free = 1044,                           /* -free */
  OPT_freg_struct_return = 1045,             /* -freg-struct-return */
  /* OPT_fregmove = 1046, */                 /* -fregmove */
  OPT_frelease = 1047,                       /* -frelease */
  OPT_frename_registers = 1048,              /* -frename-registers */
  OPT_freorder_blocks = 1049,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1050,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1051,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1052,             /* -freorder-functions */
  OPT_frepack_arrays = 1053,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1054,          /* -freplace-objc-classes */
  OPT_frepo = 1055,                          /* -frepo */
  OPT_freport_bug = 1056,                    /* -freport-bug */
  OPT_frequire_return_statement = 1057,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1058,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1059, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1060,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1061,                   /* -fresolution= */
  OPT_frounding_math = 1062,                 /* -frounding-math */
  OPT_frtti = 1063,                          /* -frtti */
  OPT_fsanitize_address_use_after_scope = 1064,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1065,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1066,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1067,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1068,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1069,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1070,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1071,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1072, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1073,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1074,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1075,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1076,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1077,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1078,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1079,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1080,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1081,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1082,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1083,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1084,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1085,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1086,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1087,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1088,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1089, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1090,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1091,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1092,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1093,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1094,               /* -fsection-anchors */
  /* OPT_fsee = 1095, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1096,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1097,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1098,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1099,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1100,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1101,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1102,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1103,                   /* -fshort-enums */
  OPT_fshort_wchar = 1104,                   /* -fshort-wchar */
  OPT_fshow_column = 1105,                   /* -fshow-column */
  OPT_fshrink_wrap = 1106,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1107,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1108,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1109,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1110,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1111,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1112,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1113,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1114,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1115,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1116,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1117,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1118,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1119,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1120,              /* -fsplit-wide-types */
  OPT_fsquangle = 1121,                      /* -fsquangle */
  OPT_fssa_backprop = 1122,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1123,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1124,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1125,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1126, */             /* -fstack-check */
  OPT_fstack_check_ = 1127,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1128,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1129,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1130,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1131,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1132,               /* -fstack-protector */
  OPT_fstack_protector_all = 1133,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1134,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1135,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1136,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1137,                   /* -fstack-usage */
  OPT_fstats = 1138,                         /* -fstats */
  OPT_fstdarg_opt = 1139,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1140,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1141, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1142,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1143,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1144,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1145,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1146,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1147, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1148,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1149,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1150,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1151,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1152,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1153, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1154,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1155, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1156,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1157, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1158,               /* -ftemplate-depth= */
  OPT_fterminated_vtables = 1159,            /* -fterminated-vtables */
  OPT_ftest_coverage = 1160,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1161,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1162,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1163,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1164,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1165,                   /* -ftime-report */
  OPT_ftime_report_details = 1166,           /* -ftime-report-details */
  OPT_ftls_model_ = 1167,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1168,              /* -ftoplevel-reorder */
  OPT_ftracer = 1169,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1170,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1171,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1172,                   /* -ftrampolines */
  OPT_ftransition_all = 1173,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1174,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1175,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1176,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1177,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1178,              /* -ftransition=field */
  OPT_ftransition_import = 1179,             /* -ftransition=import */
  OPT_ftransition_nogc = 1180,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1181,                /* -ftransition=tls */
  OPT_ftrapping_math = 1182,                 /* -ftrapping-math */
  OPT_ftrapv = 1183,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1184,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1185,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1186,                      /* -ftree-ccp */
  OPT_ftree_ch = 1187,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1188, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1189,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1190,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1191, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1192,                   /* -ftree-cselim */
  OPT_ftree_dce = 1193,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1194,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1195,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1196,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1197,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1198, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1199,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1200,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1201, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1202,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1203,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1204, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1205,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1206,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1207,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1208,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1209,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1210,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1211,                      /* -ftree-pre */
  OPT_ftree_pta = 1212,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1213,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1214, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1215,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1216,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1217,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1218,                     /* -ftree-slsr */
  OPT_ftree_sra = 1219,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1220, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1221, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1222,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1223,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1224,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1225, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1226,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1227, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1228,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1229,         /* -funconstrained-commons */
  OPT_funderscoring = 1230,                  /* -funderscoring */
  OPT_funit_at_a_time = 1231,                /* -funit-at-a-time */
  OPT_funittest = 1232,                      /* -funittest */
  OPT_funroll_all_loops = 1233,              /* -funroll-all-loops */
  OPT_funroll_loops = 1234,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1235, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1236,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1237,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1238,                 /* -funsigned-char */
  OPT_funswitch_loops = 1239,                /* -funswitch-loops */
  OPT_funwind_tables = 1240,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1241,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1242,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1243,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1244,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1245,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1246,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1247,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1248,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1249,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1250,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1251,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1252, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1253,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1254,                   /* -fverbose-asm */
  /* OPT_fversion = 1255, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1256,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1257,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1258,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1259,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1260,                   /* -fvisibility= */
  OPT_fvpt = 1261,                           /* -fvpt */
  OPT_fvtable_gc = 1262,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1263,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1264,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1265,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1266,                     /* -fvtv-debug */
  OPT_fweak = 1267,                          /* -fweak */
  OPT_fweb = 1268,                           /* -fweb */
  /* OPT_fwhole_file = 1269, */              /* -fwhole-file */
  OPT_fwhole_program = 1270,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1271,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1272,             /* -fworking-directory */
  OPT_fwpa = 1273,                           /* -fwpa */
  OPT_fwpa_ = 1274,                          /* -fwpa= */
  OPT_fwrapv = 1275,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1276,                 /* -fwrapv-pointer */
  OPT_fxref = 1277,                          /* -fxref */
  /* OPT_fzee = 1278, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1279,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1280,                     /* -fzero-link */
  OPT_g = 1281,                              /* -g */
  OPT_gant = 1282,                           /* -gant */
  OPT_gas_loc_support = 1283,                /* -gas-loc-support */
  OPT_gas_locview_support = 1284,            /* -gas-locview-support */
  OPT_gcoff = 1285,                          /* -gcoff */
  OPT_gcoff1 = 1286,                         /* -gcoff1 */
  OPT_gcoff2 = 1287,                         /* -gcoff2 */
  OPT_gcoff3 = 1288,                         /* -gcoff3 */
  OPT_gcolumn_info = 1289,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1290,                 /* -gdescribe-dies */
  OPT_gdwarf = 1291,                         /* -gdwarf */
  OPT_gdwarf_ = 1292,                        /* -gdwarf- */
  OPT_gen_decls = 1293,                      /* -gen-decls */
  OPT_gfull = 1294,                          /* -gfull */
  OPT_ggdb = 1295,                           /* -ggdb */
  OPT_ggnu_pubnames = 1296,                  /* -ggnu-pubnames */
  OPT_ginline_points = 1297,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1298, /* -ginternal-reset-location-views */
  OPT_gnat = 1299,                           /* -gnat */
  OPT_gnatO = 1300,                          /* -gnatO */
  OPT_gno_ = 1301,                           /* -gno- */
  OPT_gno_pubnames = 1302,                   /* -gno-pubnames */
  OPT_gpubnames = 1303,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1304,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1305,                   /* -gsplit-dwarf */
  OPT_gstabs = 1306,                         /* -gstabs */
  OPT_gstabs_ = 1307,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1308,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1309,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1310,                        /* -gtoggle */
  OPT_gused = 1311,                          /* -gused */
  OPT_gvariable_location_views = 1312,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1313,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1314,                           /* -gvms */
  OPT_gxcoff = 1315,                         /* -gxcoff */
  OPT_gxcoff_ = 1316,                        /* -gxcoff+ */
  OPT_gz = 1317,                             /* -gz */
  OPT_gz_ = 1318,                            /* -gz= */
  OPT_h = 1319,                              /* -h */
  OPT_headerpad_max_install_names = 1320,    /* -headerpad_max_install_names */
  OPT_idirafter = 1321,                      /* -idirafter */
  OPT_iframework = 1322,                     /* -iframework */
  OPT_imacros = 1323,                        /* -imacros */
  /* OPT_image_base = 1324, */               /* -image_base */
  OPT_imultiarch = 1325,                     /* -imultiarch */
  OPT_imultilib = 1326,                      /* -imultilib */
  OPT_include = 1327,                        /* -include */
  /* OPT_init = 1328, */                     /* -init */
  /* OPT_install_name = 1329, */             /* -install_name */
  OPT_iplugindir_ = 1330,                    /* -iplugindir= */
  OPT_iprefix = 1331,                        /* -iprefix */
  OPT_iquote = 1332,                         /* -iquote */
  OPT_isysroot = 1333,                       /* -isysroot */
  OPT_isystem = 1334,                        /* -isystem */
  OPT_iwithprefix = 1335,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1336,              /* -iwithprefixbefore */
  OPT_k8 = 1337,                             /* -k8 */
  OPT_keep_private_externs = 1338,           /* -keep_private_externs */
  OPT_l = 1339,                              /* -l */
  OPT_lang_asm = 1340,                       /* -lang-asm */
  OPT_m128bit_long_double = 1341,            /* -m128bit-long-double */
  OPT_m16 = 1342,                            /* -m16 */
  OPT_m32 = 1343,                            /* -m32 */
  OPT_m3dnow = 1344,                         /* -m3dnow */
  OPT_m3dnowa = 1345,                        /* -m3dnowa */
  OPT_m64 = 1346,                            /* -m64 */
  OPT_m80387 = 1347,                         /* -m80387 */
  OPT_m8bit_idiv = 1348,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1349,             /* -m96bit-long-double */
  OPT_mabi_ = 1350,                          /* -mabi= */
  OPT_mabm = 1351,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1352,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1353,                 /* -maddress-mode= */
  OPT_madx = 1354,                           /* -madx */
  OPT_maes = 1355,                           /* -maes */
  OPT_malign_data_ = 1356,                   /* -malign-data= */
  OPT_malign_double = 1357,                  /* -malign-double */
  OPT_malign_functions_ = 1358,              /* -malign-functions= */
  OPT_malign_jumps_ = 1359,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1360,                  /* -malign-loops= */
  OPT_malign_stringops = 1361,               /* -malign-stringops */
  OPT_march_ = 1362,                         /* -march= */
  OPT_masm_ = 1363,                          /* -masm= */
  OPT_matt_stubs = 1364,                     /* -matt-stubs */
  OPT_mavx = 1365,                           /* -mavx */
  OPT_mavx2 = 1366,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1367,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1368,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1369,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1370,                  /* -mavx5124vnniw */
  OPT_mavx512bitalg = 1371,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1372,                      /* -mavx512bw */
  OPT_mavx512cd = 1373,                      /* -mavx512cd */
  OPT_mavx512dq = 1374,                      /* -mavx512dq */
  OPT_mavx512er = 1375,                      /* -mavx512er */
  OPT_mavx512f = 1376,                       /* -mavx512f */
  OPT_mavx512ifma = 1377,                    /* -mavx512ifma */
  OPT_mavx512pf = 1378,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1379,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1380,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1381,                      /* -mavx512vl */
  OPT_mavx512vnni = 1382,                    /* -mavx512vnni */
  OPT_mavx512vpopcntdq = 1383,               /* -mavx512vpopcntdq */
  OPT_mbmi = 1384,                           /* -mbmi */
  OPT_mbmi2 = 1385,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1386,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1387,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1388,                    /* -mcet-switch */
  OPT_mcld = 1389,                           /* -mcld */
  OPT_mcldemote = 1390,                      /* -mcldemote */
  OPT_mclflushopt = 1391,                    /* -mclflushopt */
  OPT_mclwb = 1392,                          /* -mclwb */
  OPT_mclzero = 1393,                        /* -mclzero */
  OPT_mcmodel_ = 1394,                       /* -mcmodel= */
  OPT_mconstant_cfstrings = 1395,            /* -mconstant-cfstrings */
  /* OPT_mcpu_ = 1396, */                    /* -mcpu= */
  OPT_mcrc32 = 1397,                         /* -mcrc32 */
  OPT_mcx16 = 1398,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1399,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1400,            /* -mdump-tune-features */
  OPT_mdynamic_no_pic = 1401,                /* -mdynamic-no-pic */
  OPT_mf16c = 1402,                          /* -mf16c */
  OPT_mfancy_math_387 = 1403,                /* -mfancy-math-387 */
  OPT_mfentry = 1404,                        /* -mfentry */
  OPT_mfentry_name_ = 1405,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1406,               /* -mfentry-section= */
  OPT_mfix_and_continue = 1407,              /* -mfix-and-continue */
  OPT_mfma = 1408,                           /* -mfma */
  OPT_mfma4 = 1409,                          /* -mfma4 */
  OPT_mforce_drap = 1410,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1411,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1412,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1413,                       /* -mfpmath= */
  OPT_mfsgsbase = 1414,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1415,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1416, */              /* -mfused-madd */
  OPT_mfxsr = 1417,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1418,             /* -mgeneral-regs-only */
  OPT_mgfni = 1419,                          /* -mgfni */
  OPT_mhard_float = 1420,                    /* -mhard-float */
  OPT_mhle = 1421,                           /* -mhle */
  OPT_miamcu = 1422,                         /* -miamcu */
  OPT_mieee_fp = 1423,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1424,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1425,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1426,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1427,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1428,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1429,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1430, */            /* -mintel-syntax */
  OPT_mkernel = 1431,                        /* -mkernel */
  OPT_mlarge_data_threshold_ = 1432,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1433,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1434,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1435,                /* -mlong-double-80 */
  OPT_mlwp = 1436,                           /* -mlwp */
  OPT_mlzcnt = 1437,                         /* -mlzcnt */
  OPT_mmacosx_version_min_ = 1438,           /* -mmacosx-version-min= */
  OPT_mmanual_endbr = 1439,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1440,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1441,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1442,                  /* -mmitigate-rop */
  OPT_mmmx = 1443,                           /* -mmmx */
  OPT_mmovbe = 1444,                         /* -mmovbe */
  OPT_mmovdir64b = 1445,                     /* -mmovdir64b */
  OPT_mmovdiri = 1446,                       /* -mmovdiri */
  OPT_mmpx = 1447,                           /* -mmpx */
  OPT_mms_bitfields = 1448,                  /* -mms-bitfields */
  OPT_mmwaitx = 1449,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1450,            /* -mno-align-stringops */
  OPT_mno_default = 1451,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1452,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1453,                  /* -mno-push-args */
  OPT_mno_red_zone = 1454,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1455,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1456,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1457,       /* -momit-leaf-frame-pointer */
  OPT_mone_byte_bool = 1458,                 /* -mone-byte-bool */
  OPT_mpc32 = 1459,                          /* -mpc32 */
  OPT_mpc64 = 1460,                          /* -mpc64 */
  OPT_mpc80 = 1461,                          /* -mpc80 */
  OPT_mpclmul = 1462,                        /* -mpclmul */
  OPT_mpcommit = 1463,                       /* -mpcommit */
  OPT_mpconfig = 1464,                       /* -mpconfig */
  OPT_mpku = 1465,                           /* -mpku */
  OPT_mpopcnt = 1466,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1467, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1468,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1469,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1470,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1471,                        /* -mprfchw */
  OPT_mptwrite = 1472,                       /* -mptwrite */
  OPT_mpush_args = 1473,                     /* -mpush-args */
  OPT_mrdpid = 1474,                         /* -mrdpid */
  OPT_mrdrnd = 1475,                         /* -mrdrnd */
  OPT_mrdseed = 1476,                        /* -mrdseed */
  OPT_mrecip = 1477,                         /* -mrecip */
  OPT_mrecip_ = 1478,                        /* -mrecip= */
  OPT_mrecord_mcount = 1479,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1480,                 /* -mrecord-return */
  OPT_mred_zone = 1481,                      /* -mred-zone */
  OPT_mregparm_ = 1482,                      /* -mregparm= */
  OPT_mrtd = 1483,                           /* -mrtd */
  OPT_mrtm = 1484,                           /* -mrtm */
  OPT_msahf = 1485,                          /* -msahf */
  OPT_msgx = 1486,                           /* -msgx */
  OPT_msha = 1487,                           /* -msha */
  OPT_mshstk = 1488,                         /* -mshstk */
  OPT_mskip_rax_setup = 1489,                /* -mskip-rax-setup */
  OPT_msoft_float = 1490,                    /* -msoft-float */
  OPT_msse = 1491,                           /* -msse */
  OPT_msse2 = 1492,                          /* -msse2 */
  OPT_msse2avx = 1493,                       /* -msse2avx */
  OPT_msse3 = 1494,                          /* -msse3 */
  OPT_msse4 = 1495,                          /* -msse4 */
  OPT_msse4_1 = 1496,                        /* -msse4.1 */
  OPT_msse4_2 = 1497,                        /* -msse4.2 */
  OPT_msse4a = 1498,                         /* -msse4a */
  /* OPT_msse5 = 1499, */                    /* -msse5 */
  OPT_msseregparm = 1500,                    /* -msseregparm */
  OPT_mssse3 = 1501,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1502,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1503, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1504,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1505, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1506,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1507,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1508,            /* -mstringop-strategy= */
  OPT_mstv = 1509,                           /* -mstv */
  OPT_mtarget_linker = 1510,                 /* -mtarget-linker */
  OPT_mtbm = 1511,                           /* -mtbm */
  OPT_mtls_dialect_ = 1512,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1513,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1514,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1515,                         /* -mtune= */
  /* OPT_multi_module = 1516, */             /* -multi_module */
  /* OPT_multiply_defined = 1517, */         /* -multiply_defined */
  /* OPT_multiply_defined_unused = 1518, */  /* -multiply_defined_unused */
  OPT_mvaes = 1519,                          /* -mvaes */
  OPT_mveclibabi_ = 1520,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1521,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1522,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1523,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1524,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1525,                      /* -mwbnoinvd */
  OPT_mx32 = 1526,                           /* -mx32 */
  OPT_mxop = 1527,                           /* -mxop */
  OPT_mxsave = 1528,                         /* -mxsave */
  OPT_mxsavec = 1529,                        /* -mxsavec */
  OPT_mxsaveopt = 1530,                      /* -mxsaveopt */
  OPT_mxsaves = 1531,                        /* -mxsaves */
  OPT_n = 1532,                              /* -n */
  OPT_no_canonical_prefixes = 1533,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1534,              /* -no-integrated-cpp */
  OPT_no_pie = 1535,                         /* -no-pie */
  /* OPT_no_dead_strip_inits_and_terms = 1536, *//* -no_dead_strip_inits_and_terms */
  OPT_nocpp = 1537,                          /* -nocpp */
  OPT_nodefaultlibs = 1538,                  /* -nodefaultlibs */
  OPT_nofixprebinding = 1539,                /* -nofixprebinding */
  OPT_nolibc = 1540,                         /* -nolibc */
  OPT_nomultidefs = 1541,                    /* -nomultidefs */
  OPT_nophoboslib = 1542,                    /* -nophoboslib */
  OPT_noprebind = 1543,                      /* -noprebind */
  OPT_noseglinkedit = 1544,                  /* -noseglinkedit */
  OPT_nostartfiles = 1545,                   /* -nostartfiles */
  OPT_nostdinc = 1546,                       /* -nostdinc */
  OPT_nostdinc__ = 1547,                     /* -nostdinc++ */
  OPT_nostdlib = 1548,                       /* -nostdlib */
  OPT_o = 1549,                              /* -o */
  OPT_object = 1550,                         /* -object */
  OPT_p = 1551,                              /* -p */
  OPT_pagezero_size = 1552,                  /* -pagezero_size */
  OPT_pass_exit_codes = 1553,                /* -pass-exit-codes */
  /* OPT_pedantic = 1554, */                 /* -pedantic */
  OPT_pedantic_errors = 1555,                /* -pedantic-errors */
  OPT_pg = 1556,                             /* -pg */
  OPT_pie = 1557,                            /* -pie */
  OPT_pipe = 1558,                           /* -pipe */
  OPT_prebind = 1559,                        /* -prebind */
  OPT_prebind_all_twolevel_modules = 1560,   /* -prebind_all_twolevel_modules */
  OPT_preload = 1561,                        /* -preload */
  OPT_print_file_name_ = 1562,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1563,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1564,          /* -print-multi-directory */
  OPT_print_multi_lib = 1565,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1566,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1567,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1568,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1569,               /* -print-prog-name= */
  OPT_print_search_dirs = 1570,              /* -print-search-dirs */
  OPT_print_sysroot = 1571,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1572,   /* -print-sysroot-headers-suffix */
  OPT_private_bundle = 1573,                 /* -private_bundle */
  OPT_pthread = 1574,                        /* -pthread */
  OPT_quiet = 1575,                          /* -quiet */
  OPT_r = 1576,                              /* -r */
  OPT_rdynamic = 1577,                       /* -rdynamic */
  OPT_read_only_relocs = 1578,               /* -read_only_relocs */
  OPT_remap = 1579,                          /* -remap */
  OPT_s = 1580,                              /* -s */
  OPT_save_temps = 1581,                     /* -save-temps */
  OPT_save_temps_ = 1582,                    /* -save-temps= */
  OPT_sectalign = 1583,                      /* -sectalign */
  OPT_sectcreate = 1584,                     /* -sectcreate */
  OPT_sectobjectsymbols = 1585,              /* -sectobjectsymbols */
  OPT_sectorder = 1586,                      /* -sectorder */
  OPT_seg1addr = 1587,                       /* -seg1addr */
  /* OPT_seg_addr_table = 1588, */           /* -seg_addr_table */
  /* OPT_seg_addr_table_filename = 1589, */  /* -seg_addr_table_filename */
  /* OPT_segaddr = 1590, */                  /* -segaddr */
  OPT_segcreate = 1591,                      /* -segcreate */
  OPT_seglinkedit = 1592,                    /* -seglinkedit */
  OPT_segprot = 1593,                        /* -segprot */
  /* OPT_segs_read_only_addr = 1594, */      /* -segs_read_only_addr */
  /* OPT_segs_read_write_addr = 1595, */     /* -segs_read_write_addr */
  OPT_shared = 1596,                         /* -shared */
  OPT_shared_libgcc = 1597,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1598,               /* -shared-libphobos */
  /* OPT_single_module = 1599, */            /* -single_module */
  /* OPT_specs = 1600, */                    /* -specs */
  OPT_specs_ = 1601,                         /* -specs= */
  OPT_static = 1602,                         /* -static */
  OPT_static_libasan = 1603,                 /* -static-libasan */
  OPT_static_libgcc = 1604,                  /* -static-libgcc */
  OPT_static_libgfortran = 1605,             /* -static-libgfortran */
  OPT_static_libgo = 1606,                   /* -static-libgo */
  OPT_static_liblsan = 1607,                 /* -static-liblsan */
  OPT_static_libmpx = 1608,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1609,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1610,               /* -static-libphobos */
  OPT_static_libstdc__ = 1611,               /* -static-libstdc++ */
  OPT_static_libtsan = 1612,                 /* -static-libtsan */
  OPT_static_libubsan = 1613,                /* -static-libubsan */
  OPT_static_pie = 1614,                     /* -static-pie */
  /* OPT_std_c__03 = 1615, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1616, */                /* -std=c++0x */
  OPT_std_c__11 = 1617,                      /* -std=c++11 */
  OPT_std_c__14 = 1618,                      /* -std=c++14 */
  OPT_std_c__17 = 1619,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1620, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1621, */                /* -std=c++1z */
  OPT_std_c__2a = 1622,                      /* -std=c++2a */
  OPT_std_c__98 = 1623,                      /* -std=c++98 */
  OPT_std_c11 = 1624,                        /* -std=c11 */
  OPT_std_c17 = 1625,                        /* -std=c17 */
  /* OPT_std_c18 = 1626, */                  /* -std=c18 */
  /* OPT_std_c1x = 1627, */                  /* -std=c1x */
  OPT_std_c2x = 1628,                        /* -std=c2x */
  /* OPT_std_c89 = 1629, */                  /* -std=c89 */
  OPT_std_c90 = 1630,                        /* -std=c90 */
  OPT_std_c99 = 1631,                        /* -std=c99 */
  /* OPT_std_c9x = 1632, */                  /* -std=c9x */
  OPT_std_f2003 = 1633,                      /* -std=f2003 */
  OPT_std_f2008 = 1634,                      /* -std=f2008 */
  OPT_std_f2008ts = 1635,                    /* -std=f2008ts */
  OPT_std_f2018 = 1636,                      /* -std=f2018 */
  OPT_std_f95 = 1637,                        /* -std=f95 */
  OPT_std_gnu = 1638,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1639, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1640, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1641,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1642,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1643,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1644, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1645, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1646,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1647,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1648,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1649,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1650, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1651, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1652,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1653, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1654,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1655,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1656, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1657, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1658,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1659, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1660, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1661, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1662, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1663, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1664,                     /* -std=legacy */
  OPT_sub_library = 1665,                    /* -sub_library */
  OPT_sub_umbrella = 1666,                   /* -sub_umbrella */
  OPT_symbolic = 1667,                       /* -symbolic */
  OPT_t = 1668,                              /* -t */
  OPT_time = 1669,                           /* -time */
  OPT_time_ = 1670,                          /* -time= */
  OPT_traditional = 1671,                    /* -traditional */
  OPT_traditional_cpp = 1672,                /* -traditional-cpp */
  OPT_trigraphs = 1673,                      /* -trigraphs */
  OPT_twolevel_namespace = 1674,             /* -twolevel_namespace */
  OPT_twolevel_namespace_hints = 1675,       /* -twolevel_namespace_hints */
  OPT_u = 1676,                              /* -u */
  /* OPT_umbrella = 1677, */                 /* -umbrella */
  OPT_undef = 1678,                          /* -undef */
  OPT_undefined = 1679,                      /* -undefined */
  /* OPT_unexported_symbols_list = 1680, */  /* -unexported_symbols_list */
  OPT_v = 1681,                              /* -v */
  OPT_version = 1682,                        /* -version */
  OPT_w = 1683,                              /* -w */
  /* OPT_weak_reference_mismatches = 1684, *//* -weak_reference_mismatches */
  OPT_whatsloaded = 1685,                    /* -whatsloaded */
  OPT_whyload = 1686,                        /* -whyload */
  OPT_wrapper = 1687,                        /* -wrapper */
  OPT_x = 1688,                              /* -x */
  OPT_y = 1689,                              /* -y */
  OPT_z = 1690,                              /* -z */
  N_OPTS,
